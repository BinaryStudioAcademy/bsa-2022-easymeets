...
public interface ITeamService
{
    ...
    Task<List<TeamDto>> GetCurrentUserAdminAndOwnerTeams();
    ...
    Task<ICollection<NewMeetingMemberDto>> GetTeamMembersOfCurrentUserByNameAsync(string searchName, long? teamId);
