    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSlot", x => new { x.MembersId, x.SlotsId });
                    table.ForeignKey(
                        name: "FK_UserSlot_AvailabilitySlots_SlotsId",
                        column: x => x.SlotsId,
                        principalTable: "AvailabilitySlots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSlot_Users_MembersId",
            ...
            migrationBuilder.CreateTable(
                name: "CalendarVisibleForTeam",
                columns: table => new
                {
                    VisibleCalendarsId = table.Column<int>(type: "int", nullable: false),
                    VisibleForTeamsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CalendarVisibleForTeam", x => new { x.VisibleCalendarsId, x.VisibleForTeamsId });
                    table.ForeignKey(
                        name: "FK_CalendarVisibleForTeam_Calendars_VisibleCalendarsId",
                        column: x => x.VisibleCalendarsId,
                        principalTable: "Calendars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CalendarVisibleForTeam_Teams_VisibleForTeamsId",
                        column: x => x.VisibleForTeamsId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CalendarVisibleForTeam_VisibleForTeamsId",
                table: "CalendarVisibleForTeam",
                column: "VisibleForTeamsId");
