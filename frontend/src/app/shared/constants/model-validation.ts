...
export const newMeetingNameRegex = '^[єЄіІїЇa-zA-Z\\dа-яА-Я-]+(\\s|)[єЄіІїЇa-zA-Z\\dа-яА-Я-]*$';
...
export const teamNameRegex: RegExp = /^[іІїЇaєЄa-zA-Z\dа-яА-Я-]+(\s|)[іІїЇєЄa-zA-Z\dа-яА-Я-]*$/;
export const teamDescriptionRegex: RegExp = /^[.,іІїЇaєЄa-zA-Z\dа-яА-Я-\s]*$/;
